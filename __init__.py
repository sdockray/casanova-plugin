...
class CasanovaPlugin(InterfaceActionBase):
    '''
    ...
    actual_plugin       = 'calibre_plugins.casanova_plugin.ui:CasanovaUI'
    ...
    def config_widget(self):
        ...
        from calibre_plugins.casanova_plugin.config import ConfigWidget
        return ConfigWidget()
